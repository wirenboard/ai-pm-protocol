...
// capability modules' fragments (composed at the body's `<!-- ai-pm:modules -->`
...
// .fm adds only Claude's frontmatter, and the agent id comes from ai-pm.config.json
...
// project's own ai-pm.config.json by default; AI_PM_CONFIG lets a test drive a
