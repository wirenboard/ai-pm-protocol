...
- `[light]` **Ratchet present** — a gate-caught bug ships WITH its test-first ratchet (RED on the buggy code, then GREEN); a bug-fix without its ratchet test is a finding.
