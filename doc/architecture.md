...
| `.claude/agents/` | Eight persona files (`pm-architect`, `pm-auditor`, `pm-coder`, `pm-legacy-reader`, `pm-pr-prep`, `pm-plan-checker`, `pm-product-advocate`, `pm-stack-researcher`). |
