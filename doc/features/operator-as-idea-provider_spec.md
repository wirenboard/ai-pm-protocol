...
- **Расширение** уже существующей `## Operator-facing tone` секции (добавлена в PR #72) во всех 9 agent prompt'ах (`.claude/agents/*.md`) — добавляем 6 rules + 6 escalation triggers, не дублируем уже-внесённый baseline.
...
- [ ] Все 9 agent prompts содержат «Operator-facing tone» секцию с 6 rules + 6 escalation triggers.
