...
Объясняет PM что сделано и как попробовать — без кода
        ↓
Reviewer-агент проверяет по 8 измерениям: план (полнота + соответствие стеку),
...
> Перечень рисков на продуктовом уровне. Точные формулировки правил, по которым reviewer / auditor / hooks действуют — в [`WORKFLOW.md`](WORKFLOW.md) и в `.claude/agents/*.md`.
...
> Расширенные правила общения PM ↔ агенты — в [`WORKFLOW.md` § "How to talk to the PM"](WORKFLOW.md).
