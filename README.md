...
| **Spec / use-case linting** (§ 9) | Дисциплина foundational docs + feature spec'ов | `scripts/check-spec-discipline.sh` (catalogue из 11 checks) | personas-exist, journeys-reference-personas, mvp-scope-no-orphans, spec-references-persona, spec-impact-fields-present (AP-14), pr-ordering-for-multi-domain (AP-19), rework-has-diff-section |
